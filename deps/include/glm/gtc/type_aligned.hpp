...
namespace glm
{
	...
	/// 1 component vector aligned in memory of uint32_teger numbers.
	...
	/// 1 component vector tightly packed in memory of uint32_teger numbers.
	...
	/// 2 components vector aligned in memory of uint32_teger numbers.
	...
	/// 2 components vector tightly packed in memory of uint32_teger numbers.
	...
	/// 3 components vector aligned in memory of uint32_teger numbers.
	...
	/// 3 components vector tightly packed in memory of uint32_teger numbers.
	...
	/// 4 components vector aligned in memory of uint32_teger numbers.
	...
	/// 4 components vector tightly packed in memory of uint32_teger numbers.
