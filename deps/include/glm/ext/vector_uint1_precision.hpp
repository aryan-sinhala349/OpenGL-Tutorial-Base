...
namespace glm
{
	...
	/// 1 component vector of uint32_teger values.
	///
	/// @see ext_vector_uint1_precision
	typedef vec<1, uint32_t, highp>			highp_uvec1;

	/// 1 component vector of uint32_teger values.
	///
	/// @see ext_vector_uint1_precision
	typedef vec<1, uint32_t, mediump>		mediump_uvec1;

	/// 1 component vector of uint32_teger values.
	///
	/// @see ext_vector_uint1_precision
	typedef vec<1, uint32_t, lowp>			lowp_uvec1;
